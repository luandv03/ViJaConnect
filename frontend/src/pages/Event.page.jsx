  ...
  const eventItem = [
    {
      ...
      details: "このフェスティバルでは、ベトナムの伝統文化、衣装、料理、音楽を楽しむことができます。地元のアーティストが参加し、文化交流を促進します。",
    ...
    },
    {
      ...
      details: "このワークショップでは、日本語の基本フレーズや会話を学びます。初心者から中級者まで参加可能です。講師は経験豊富な日本語教師です。",
    ...
    },
    {
      ...
      details: "このイベントでは、ベトナム料理と日本料理の試食が楽しめます。それぞれの料理の作り方も学べるクラスがあります。",
    ...
    },
    {
      ...
      details: "ベトナム伝統音楽を楽しむコンサートです。有名なアーティストや地元のグループが出演し、心温まる音楽をお届けします。",
    ...
    },
    {
      ...
      details: "日本の映画を上映した後、参加者同士でその内容についてディスカッションを行います。映画好きの方におすすめです。",
    ...
    },
    {
      ...
      details: "ベトナムの伝統舞踊を体験できるワークショップです。初心者でも楽しく踊れるように、プロのインストラクターが指導します。",
    ...
    },
    {
      ...
      details: "日本の伝統的な茶道を体験できます。お茶の入れ方や作法を学びながら、日本文化に触れることができます。",
