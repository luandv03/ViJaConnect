    ...
    <div className="sidebar max-w-96">
      <Link to="/">
        <div className="px-4 py-3 border-b border-red-600">
          <div
            className={`rounded-xl flex justify-between items-center px-3 py-2 ${isActive ? "bg-alice-blue" : ""
              }`}
          >
            <h2>ホーム</h2>
          </div>
      ...
      <div className="py-4 pl-4 border-b border-red-600">
        <div
          className={`flex items-center mb-3 cursor-pointer justify-between mr-4 p-4 ${topicActive ? "bg-alice-blue" : ""
            }`}
        >
          <h2>トピック</h2>
          <IconPlus
      ...
      <div className="p-4">
        <Link to="/event">
          <div
            className={`flex items-center justify-between p-4 rounded-lg ${eventActive ? "bg-alice-blue" : ""
              }`}
          >
