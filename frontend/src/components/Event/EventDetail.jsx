        ...
        <>
            ...
            <div className="px-10 mb-4">
                <div className="w-full h-[500px] bg-gray-200 flex items-center justify-center rounded-md">
                    <img
                        src="https://meetsvietnam.vietnamairlines.com/wp-content/uploads/2024/07/448504984_870598721767452_1562326102109704185_n.jpg"
                        alt="event banner"
            ...
            {isAdminOrManager ? (
                ...
                <div className="px-10">
                    <div className="flex justify-between items-center space-x-4">
                        <button
                            onClick={handleLike}
                            className={`py-2 px-4 flex items-center rounded-2xl border transition ${
                        ...
                        <button
                            onClick={handleJoin}
                            className={`py-2 px-4 flex items-center rounded-2xl border transition ${
                                isJoined ? "bg-green-100 text-green-600" : ""
                            }`}
                        >
                            <IconCheck
                                stroke={2}
